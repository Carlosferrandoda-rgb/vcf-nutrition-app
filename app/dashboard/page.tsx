  ...
  return (
    <div className='container'>
      ...
      <div className='grid grid-3' style={{ marginBottom: 16 }}>
        ...
        <a href='/dashboard/menu' className='kpi' style={{ textDecoration: 'none', color: 'inherit', cursor: 'pointer' }}>
          <span className='muted small'>Menú esta semana</span>
          <strong style={{ color: '#f59e0b' }}>Ver menú →</strong>
        </a>
      </div>
        ...
        <div className='stack'>
          <div className='card stack'>
            ...
            {players && players.length > 0 ? (
              ...
              <p className='muted small' style={{ color: error ? 'red' : undefined }}>
                {error ? 'Error: ' + error.message : 'Sin jugadores. Importa un Excel.'}
              </p>
            )}
          </div>
          <FoodCalculator />
